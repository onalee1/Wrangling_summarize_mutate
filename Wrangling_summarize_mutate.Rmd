...
Flipping both data sets of mutate and summarize was able to be done as seen by the new data sets of average_length_hours and average _length_hours_flipped. I would say using mutate first leads to a more straight forward answer as it give us the average length in hours right away when we need it but using summarize first then mutate shows the process that lead to the data which has its uses for tracking progression.
